        ...
        <div class="row" style="margin-top:45px">
           <div class="col-md-4 col-md-offset-4"></div>
            <div class="col-md-4 col-md-offset-4">
                <h4>Company Registeration</h4><hr>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="companyid" placeholder="Enter Id" value="{{ old('companyid') }}" >
                       <span class="text-danger">@error('companyid'){{ $message }} @enderror</span>
                    </div>
                    <div class="form-group">
                       <label>Address</label>
                    ...
                    <br>
                    <a href="{{route('auth.login')}}">I already have an account,Go to login</a>                   
                </form>
            </div>
            <div class="col-md-4 col-md-offset-4"></div>
        </div>
